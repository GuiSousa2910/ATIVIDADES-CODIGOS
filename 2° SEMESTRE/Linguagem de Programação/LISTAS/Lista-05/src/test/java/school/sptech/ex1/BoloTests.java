...
public class BoloTests {
  ...
  class AtributosTests {
    ...
    void validarAtributos() {
      ...
      Assertions.assertAll(
          ...
          () -> Assertions.assertDoesNotThrow(() -> clazz.getDeclaredField("qntVenda")),
          () -> Assertions.assertDoesNotThrow(() -> clazz.getDeclaredField("qntEstoque"))
      );
    }
  }
  ...
  class MetodoVenderBoloTests {
    ...
    Map<String, Field> campos() throws ReflectiveOperationException {
      ...
      return Map.of(
          ...
          "qntVenda", clazz.getDeclaredField("qntVenda"),
          "qntEstoque", clazz.getDeclaredField("qntEstoque")
      );
    }
    ...
    void cenario1() throws ReflectiveOperationException {
      ...
      campos().get("qntVenda").set(obj, 10);
      campos().get("qntEstoque").set(obj, 60);

      // When
      metodo.invoke(obj, 10);

      // Then
      Assertions.assertEquals(20, campos().get("qntVenda").get(obj));
    }
    ...
    void cenario2() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Chocolate");
      campos().get("valor").set(obj, 35.0);
      campos().get("qntVenda").set(obj, 15);
      campos().get("qntEstoque").set(obj, 40);

      // When
      metodo.invoke(obj, 25);

      // Then
      Assertions.assertEquals(40, campos().get("qntVenda").get(obj));
    }
    ...
    void cenario3() throws ReflectiveOperationException {
      ...
      // Then
      Assertions.assertEquals(0, campos().get("qntVenda").get(obj));
    }
    ...
    void cenario4() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Chocolate");
      campos().get("valor").set(obj, 35.0);
      campos().get("qntVenda").set(obj, 90);
      campos().get("qntEstoque").set(obj, 100);

      // When
      metodo.invoke(obj, 11);

      // Then
      Assertions.assertEquals(101, campos().get("qntVenda").get(obj));
    }
    ...
    void cenario5() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Chocolate");
      campos().get("valor").set(obj, 35.0);
      campos().get("qntVenda").set(obj, 30);
      campos().get("qntEstoque").set(obj, 100);
      ...
      // Then
      Assertions.assertEquals(30, campos().get("qntVenda").get(obj));
    }
    ...
    void cenario6() throws ReflectiveOperationException {
      ...
      campos().get("valor").set(obj, 35.0);
      campos().get("qntVenda").set(obj, 0);
      campos().get("qntEstoque").set(obj, 200);
  ...
  class MetodoAumentarEstoqueTests {
    ...
    void cenario1() throws ReflectiveOperationException {
      ...
      campos().get("qntVenda").set(obj, 10);
      campos().get("qntEstoque").set(obj, 10);

      // When
      metodo.invoke(obj, 10);

      // Then
      Assertions.assertEquals(20, campos().get("qntEstoque").get(obj));
    }
    ...
    void cenario2() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Morango");
      campos().get("valor").set(obj, 55.0);
      campos().get("qntVenda").set(obj, 2);
      campos().get("qntEstoque").set(obj, 20);

      // When
      metodo.invoke(obj, 24);

      // Then
      Assertions.assertEquals(44, campos().get("qntEstoque").get(obj));
    }
  ...
  class MetodoQuantidadeDisponivelTests {
    ...
    void cenario2() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Limão");
      campos().get("valor").set(obj, 45.0);
      campos().get("qntVenda").set(obj, 25);
      campos().get("qntEstoque").set(obj, 25);
    ...
    void cenario3() throws ReflectiveOperationException {
      ...
      campos().get("sabor").set(obj, "Limão");
      campos().get("valor").set(obj, 45.0);
      campos().get("qntVenda").set(obj, 35);
      campos().get("qntEstoque").set(obj, 87);
    ...
    void cenario4() throws ReflectiveOperationException {
      ...
      campos().get("valor").set(obj, 45.0);
      campos().get("qntVenda").set(obj, 2);
      campos().get("qntEstoque").set(obj, 4);
  ...
  class MetodoTotalVendidoTests {
    ...
    void cenario2() throws ReflectiveOperationException {
      ...
      campos().get("qntVenda").set(obj, 57);
      campos().get("qntEstoque").set(obj, 90);
    ...
    void cenario4() throws ReflectiveOperationException {
      ...
      campos().get("qntVenda").set(obj, 26);
      campos().get("qntEstoque").set(obj, 100);
