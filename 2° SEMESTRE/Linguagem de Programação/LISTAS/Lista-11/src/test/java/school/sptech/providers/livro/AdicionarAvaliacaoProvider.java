...
public class AdicionarAvaliacaoProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        return Stream.of(
                Arguments.of("O Senhor dos Anéis", "J. R. R. Tolkien", LocalDate.parse("1954-07-29"), List.of(), "Uma leitura cativante do início ao fim.", 5.0, List.of(a1)),
                Arguments.of("Harry Potter e a Pedra Filosofal", "J. K. Rowling", LocalDate.parse("1997-06-26"), List.of(a3, a4), "A história é boa, mas os personagens são pouco desenvolvidos.", 3.0, List.of(a3, a4, a2)),
                Arguments.of("O Pequeno Príncipe", "Antoine de Saint-Exupéry", LocalDate.parse("1943-04-06"), List.of(a1, a2, a3), "Achei a trama confusa e pouco envolvente.", 1.0, List.of(a1, a2, a3, a9)),
                Arguments.of("Dom Quixote", "Miguel de Cervantes", LocalDate.parse("1605-01-16"), List.of(a1, a3, a6, a9), "Narrativa envolvente, mas o final decepcionou.", 3.0, List.of(a1, a3, a6, a9, a10)),
                Arguments.of("1984", "George Orwell", LocalDate.parse("1949-06-08"), List.of(a5, a7), "Narrativa envolvente, mas o final decepcionou.", 3.0, List.of(a5, a7, a10))
        );
    }
}
