...
export function Card() {
    return (
        <div className="px-4 py-7 bg-white rounded-md max-w-[550px] flex flex-col gap-4">
            ...
            <div>
                <h3 className="text-sm font-semibold mb-1">Titulo Card</h3>
                <p className="text-sm font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, recusandae commodi. Doloribus ratione ullam quos consectetur magni modi, id eveniet ipsam placeat, nulla excepturi officiis fuga vel repudiandae minus corporis.</p>
